...
import carousel__multiple_3Parser from './parsers/carousel__multiple_3.js';
...
import seach__minimal_8Parser from './parsers/seach__minimal_8.js';
import columns__two_columns_10Parser from './parsers/columns__two_columns_10.js';
import columns__two_columns_11Parser from './parsers/columns__two_columns_11.js';
...
import columns__two_columns_18Parser from './parsers/columns__two_columns_18.js';
...
const parsers = {
    ...
    'Carousel (multiple) 3': carousel__multiple_3Parser,
    'Tabs 5': tabs5Parser,
    'Hero 9': hero9Parser,
    'Hero 6': hero6Parser,
    'Columns (two columns) 7': columns__two_columns_7Parser,
    'Seach (minimal) 8': seach__minimal_8Parser,
    'Columns (two columns) 10': columns__two_columns_10Parser,
    'Columns (two columns) 11': columns__two_columns_11Parser,
    'Tabs 12': tabs12Parser,
    'Hero 13': hero13Parser,
    'Hero 14': hero14Parser,
    'Hero 16': hero16Parser,
    'Columns (two columns) 18': columns__two_columns_18Parser,
};
...
export default {
  transform: async (source) => {
    ...
    // fetch the inventory
    const publishUrl = 'https://issue-24--paolom-alphabet-130325--aemdemos.aem.page';
